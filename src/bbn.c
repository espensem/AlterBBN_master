...
// err stores the high or low value
...
//   reac# type n1 n2 n3 n4 n5 n6 rev q
    ...
    {12.,1.,2.,1.,0.,0.,0.,3.,0.477,25.815},       // H + n -> g + H2          // H(n,g)H2
    {13.,1.,3.,1.,0.,0.,0.,4.,1.65,72.612},        // H2 + n -> g + H3         // H2(n,g)H3
    {14.,1.,5.,1.,0.,0.,0.,6.,2.63,238.794},       // He3 + n -> g + He4       // He3(n,g)He4
    {15.,1.,7.,1.,0.,0.,0.,8.,1.20,84.132},        // Li6 + n -> g + Li7       // Li6(n,g)Li7
    {16.,2.,5.,1.,0.,0.,2.,4.,1.001,8.863},       // He3 + n -> p + H3        // He3(n,p)H3
    {17.,2.,9.,1.,0.,0.,2.,8.,1.001,19.080},      // Be7 + n -> p + Li7       // Be7(n,p)Li7
    {18.,2.,7.,1.,0.,0.,4.,6.,1.068,55.503},      // Li6 + n -> a + H3        // Li6(n,a)H3
    {19.,4.,9.,1.,0.,0.,0.,6.,4.68,220.382},       // Be7 + n -> a + He4       // Be7(n,a)He4
    {20.,1.,3.,2.,0.,0.,0.,5.,1.65,63.749},       // H2 + p -> g + He3        // H2(p,g)He3
    {21.,1.,4.,2.,0.,0.,0.,6.,2.63,229.931},      // H3 + p -> g + He4        // H3(p,g)He4
    {22.,1.,7.,2.,0.,0.,0.,9.,1.20,65.053},       // Li6 + p -> g + Be7       // Li6(p,g)Be7
    {23.,2.,7.,2.,0.,0.,5.,6.,1.067,46.640},       // Li6 + p -> a + He3       // Li6(p,a)He3
    {24.,4.,8.,2.,0.,0.,0.,6.,4.68,201.302},      // Li7 + p -> a + He4       // Li7(p,a)He4
    {25.,1.,6.,3.,0.,0.,0.,7.,1.55,17.109},       // H2 + a -> g + Li6        // He4(d,g)Li6
    {26.,1.,6.,4.,0.,0.,0.,8.,1.13,28.629},       // H3 + a -> g + Li7        // He4(t,g)Li7
    {27.,1.,6.,5.,0.,0.,0.,9.,1.13,18.412},       // He3 + a -> g + Be7       // He3(a,g)Be7
    {28.,5.,3.,0.,0.,0.,1.,5.,1.73,37.934},       // H2 + d -> n + He3        // H2(d,n)He3
    {29.,5.,3.,0.,0.,0.,2.,4.,1.73,46.798},       // H2 + d -> p + H3         // H2(d,p)H3
    {30.,2.,4.,3.,0.,0.,1.,6.,5.51,204.116},      // H3 + d -> n + He4        // H3(d,n)He4
    {31.,2.,5.,3.,0.,0.,2.,6.,5.51,212.979},      // He3 + d -> p + He4       // He3(d,p)He4
    {32.,10.,5.,0.,0.,0.,2.,6.,3.35,149.229},     // He3 + He3 -> 2p + He4    // He3(He3,2p)He4
    {33.,8.,8.,3.,0.,0.,1.,6.,9.81,175.487},      // Li7 + d -> n + a + He4   // Li7(d,na)He4
    {34.,8.,9.,3.,0.,0.,2.,6.,9.83,194.566},      // Be7 + d -> p + a + He4   // Be7(d,pa)He4
    {35.,1.,5.,4.,0.,0.,0.,7.,2.47,183.290},      // He3 + H3 -> g + Li6      // He3(t,g)Li6
    {36.,2.,7.,3.,0.,0.,1.,9.,2.52,39.237},       // Li6 + d -> n + Be7       // Li6(d,n)Be7
    {37.,2.,7.,3.,0.,0.,2.,8.,2.52,58.317},       // Li6 + d -> p + Li7       // Li6(d,p)Li7
    {38.,2.,5.,4.,0.,0.,3.,6.,1.59,166.181},      // He3 + H3 -> d + He4      // He3(t,d)He4
    {39.,10.,4.,4.,0.,0.,1.,6.,3.34,131.503},     // H3 + H3 -> 2n + He4      // H3(t,2n)He4
    {40.,11.,5.,4.,0.,1.,2.,6.,3.34,140.366},     // He3 + H3 -> n + p + He4  // He3(t,np)He4
    {41.,2.,8.,4.,0.,0.,1.,12.,3.55,121.136},     // Li7 + H3 -> n + Be9      // Li7(t,n)Be9
    {42.,2.,9.,4.,0.,0.,2.,12.,3.55,140.215},     // Be7 + H3 -> p + Be9      // Be7(t,p)Be9
    {43.,2.,8.,5.,0.,0.,2.,12.,3.55,129.999},     // Li7 + He3 -> p + Be9     // Li7(He3,p)Be9
    {44.,1.,8.,1.,0.,0.,0.,10.,1.33,23.589},       // Li7 + n -> g + Li8       // Li7(n,g)Li8
    {45.,1.,13.,1.,0.,0.,0.,14.,3.07,132.920},     // B10 + n -> g + B11       // B10(n,g)B11
    {46.,1.,14.,1.,0.,0.,0.,16.,2.37,39.111},      // B11 + n -> g + B12       // B11(n,g)B12
    {47.,2.,15.,1.,0.,0.,2.,14.,1.001,32.086},    // C11 + n -> p + B11       // C11(n,p)B11
    {48.,2.,13.,1.,0.,0.,6.,8.,0.755,32.371},     // B10 + n -> a + Li7       // B10(n,a)Li7
    {49.,1.,9.,2.,0.,0.,0.,11.,1.32,1.595},       // Be7 + p -> g + B8        // Be7(p,g)B8
    {50.,1.,12.,2.,0.,0.,0.,13.,0.986,76.424},    // Be9 + p -> g + B10       // Be9(p,g)B10
    {51.,1.,13.,2.,0.,0.,0.,15.,3.07,100.834},    // B10 + p -> g + C11       // B10(p,g)C11
    {52.,1.,14.,2.,0.,0.,0.,17.,7.10,185.173},    // B11 + p -> g + C12       // B11(p,g)C12
    {53.,1.,15.,2.,0.,0.,0.,18.,2.37,6.979},      // C11 + p -> g + N12       // C11(p,g)N12
    {54.,2.,16.,2.,0.,0.,1.,17.,3.00,146.061},     // B12 + p -> n + C12       // B12(p,n)C12
    {55.,2.,12.,2.,0.,0.,6.,7.,0.618,24.663},     // Be9 + p -> a + Li6       // Be9(p,a)Li6
    {56.,2.,13.,2.,0.,0.,6.,9.,0.754,13.291},     // B10 + p -> a + Be7       // B10(p,a)Be7
    {57.,2.,16.,2.,0.,0.,6.,12.,0.291,79.903},     // B12 + p -> a + Be9       // B12(p,a)Be9
    {58.,1.,7.,6.,0.,0.,0.,13.,1.60,51.761},      // Li6 + a -> g + B10       // Li6(a,g)B10
    {59.,1.,8.,6.,0.,0.,0.,14.,4.07,100.549},     // Li7 + a -> g + B11       // Li7(a,g)B11
    {60.,1.,9.,6.,0.,0.,0.,15.,4.07,87.543},      // Be7 + a -> g + C11       // Be7(a,g)C11
    {61.,2.,11.,6.,0.,0.,2.,15.,3.07,85.948},      // B8 + a -> p + C11        // B8(a,p)C11
    {62.,2.,10.,6.,0.,0.,1.,14.,3.07,76.960},      // Li8 + a -> n + B11       // Li8(a,n)B11
    {63.,2.,12.,6.,0.,0.,1.,17.,10.28,66.158},     // Be9 + a -> n + C12       // Be9(a,n)C12
    {64.,2.,12.,3.,0.,0.,1.,13.,2.06,50.609},      // Be9 + d -> n + B10       // Be9(d,n)B10
    {65.,2.,13.,3.,0.,0.,2.,14.,6.42,107.105},     // B10 + d -> p + B11       // B10(d,p)B11
    {66.,2.,14.,3.,0.,0.,1.,17.,14.85,159.357},     // B11 + d -> n + C12       // B11(d,n)C12
    {67.,7.,6.,1.,0.,0.,0.,12.,0.600,18.262},     // He4 + a + n -> g + Be9   // He4(an,g)Be9
    {68.,6.,6.,0.,0.,0.,0.,17.,2.06,84.420},      // He4 + 2a -> g + C12      // He4(2a,g)C12
    {69.,8.,10.,2.,0.,0.,1.,6.,3.54,177.713},      // Li8 + p -> n + a + He4   // Li8(p,na)He4
    {70.,8.,11.,1.,0.,0.,2.,6.,3.55,218.787},      // B8 + n -> p + a + He4    // B8(n,pa)He4
    {71.,8.,12.,2.,0.,0.,3.,6.,0.796,7.554},      // Be9 + p -> d + a + He4   // Be9(p,da)He4
    {72.,9.,14.,2.,0.,0.,0.,6.,3.45,100.753},     // B11 + p -> 2a + He4      // B11(p,2a)He4
    {73.,9.,15.,1.,0.,0.,0.,6.,3.46,132.838},      // C11 + n -> 2a + He4      // C11(n,2a)He4
    {74.,1.,17.,1.,0.,0.,0.,19.,0.898,57.400},     // C12 + n -> g + C13       // C12(n,g)C13
    {75.,1.,19.,1.,0.,0.,0.,21.,3.62,94.884},      // C13 + n -> g + C14       // C13(n,g)C14
    {76.,1.,22.,1.,0.,0.,0.,24.,2.74,125.715},     // N14 + n -> g + N15       // N14(n,g)N15
    {77.,2.,20.,1.,0.,0.,2.,19.,1.001,34.846},    // N13 + n -> p + C13       // N13(n,p)C13
    {78.,2.,22.,1.,0.,0.,2.,21.,3.00,7.263},     // N14 + n -> p + C14       // N14(n,p)C14
    {79.,2.,25.,1.,0.,0.,2.,24.,1.001,41.037},    // O15 + n -> p + N15       // O15(n,p)N15
    {80.,2.,25.,1.,0.,0.,6.,17.,0.707,98.659},    // O15 + n -> a + C12       // O15(n,a)C12
    {81.,1.,17.,2.,0.,0.,0.,20.,0.896,22.554},    // C12 + p -> g + N13       // C12(p,g)N13
    {82.,1.,19.,2.,0.,0.,0.,22.,1.21,87.621},     // C13 + p -> g + N14       // C13(p,g)N14
    {83.,1.,21.,2.,0.,0.,0.,24.,0.912,118.452},   // C14 + p -> g + N15       // C14(p,g)N15
    {84.,1.,20.,2.,0.,0.,0.,23.,3.62,53.705},     // N13 + p -> g + O14       // N13(p,g)O14
    {85.,1.,22.,2.,0.,0.,0.,25.,2.73,84.678},     // N14 + p -> g + O15       // N14(p,g)O15
    {86.,2.,24.,2.,0.,0.,0.,26.,3.67,140.733},    // N15 + p -> g + O16       // N15(p,g)O16
    {87.,2.,24.,2.,0.,0.,6.,17.,0.706,57.622},	  // N15 + p -> a + C12       // N15(p,a)C12
    {88.,1.,17.,6.,0.,0.,0.,26.,5.20,83.111},     // C12 + a -> g + O16       // C12(a,g)O16
    {89.,2.,13.,6.,0.,0.,2.,19.,9.35,47.134},      // B10 + a -> p + C13       // B10(a,p)C13
    {90.,2.,14.,6.,0.,0.,2.,21.,11.03,9.098},      // B11 + a -> p + C14       // B11(a,p)C14
    {91.,2.,15.,6.,0.,0.,2.,22.,3.68,33.921},     // C11 + a -> p + N14       // C11(a,p)N14
    {92.,2.,18.,6.,0.,0.,2.,25.,4.25,111.620},     // N12 + a -> p + O15       // N12(a,p)O15
    {93.,2.,20.,6.,0.,0.,2.,26.,5.80,60.557},     // N13 + a -> p + O16       // N13(a,p)O16
    {94.,2.,13.,6.,0.,0.,1.,20.,9.34,12.288},     // B10 + a -> n + N13       // B10(a,n)N13
    {95.,2.,14.,6.,0.,0.,1.,22.,3.67,1.835},      // B11 + a -> n + N14       // B11(a,n)N14
    {96.,2.,16.,6.,0.,0.,1.,24.,4.25,88.439},      // B12 + a -> n + N15       // B12(a,n)N15
    {97.,2.,19.,6.,0.,0.,1.,26.,5.79,25.711},     // C13 + a -> n + O16       // C13(a,n)O16
    {98.,2.,14.,3.,0.,0.,2.,16.,4.96,13.296},     // B11 + d -> p + B12       // B11(d,p)B12
    {99.,2.,17.,3.,0.,0.,2.,19.,1.88,31.585},     // C12 + d -> p + C13       // C12(d,p)C13
    {100.,2.,19.,3.,0.,0.,2.,21.,7.58,69.069},    // C13 + d -> p + C14       // C13(d,p)C14
    };
    ...
    double T9i=paramrelic.Tinit;// Initial temperature, given in .ini-file.
    ...
    if (paramrelic.wimp_added)
    {
         ...
         * The hyperbolic sine and cosine is replaced with an exponential for self-conjugate particles */
        if (paramrelic.selfConjugate)
        {
            cosh1W=sinh1W=exp(phiW);
            cosh2W=sinh2W=exp(phiW*2.);
            cosh3W=sinh3W=exp(phiW*3.);
            cosh4W=sinh4W=exp(phiW*4.);
            cosh5W=sinh5W=exp(phiW*5.);
            cosh6W=sinh6W=exp(phiW*6.);
            cosh7W=sinh7W=exp(phiW*7.);
        }
        else
        {
            cosh1W=cosh(phiW);
        ...
        wimp_mass_ratio = paramrelic.mass_wimp / 0.511;        // Ratio of WIMP mass to electron mass
        zW = wimp_mass_ratio*z; // T9=Tnu initially
        zWd = wimp_mass_ratio*z*T9/Tnud; // In case iteration is started earlier than Tnud
    }
    ...
    if (paramrelic.wimp_added)
    {
        ...
        // Neff due to WIMPs (see Nollett/Steigman papers on EM and nu coupled WIMPs)
	...
	while(ltime == 0)	
	{
		for(loop=1;loop<=2;loop++)
		{
			...
			//D... Eq.(9) Original Alterbbn manual
            ...
            if ((paramrelic.wimp_added)&&((paramrelic.SM_coupling_wimp==1)||(paramrelic.SM_coupling_wimp==3)))
            {
                ...
                dlna3_dT9=-(drho_gamma_dT9+drho_epem_dT9+drho_epem_dphie*dphie_dT9+rho_baryons*1.388e-4*sum_Y
                            +T9*1e9*dsd_dT9)/
                        (rho_gamma+P_gamma+rho_epem+P_epem+rho_baryons*(9.25e-5*T9*sum_Y+1.388e-4*T9*sum_dY_dt/(H*3.)   // 2/3*zeta = 9.25e-5 - P_b
                                                                                        +sum_DeltaMdY_dt/(H*3.))
...
//   reac# type n1 n2 n3 n4 n5 n6 rev q
    ...
    double cy=0.1;              // Limiting value of dY/dt which, together with ct, controls the step-size
    double ct=0.01;             // Limiting value of dT/dt
    double T9i=paramrelic.Tinit;// Initial temperature given by .ini-file.
    double T9f=0.01;            // Final temperature
    double Ytmin =1.e-30;
    int inc=50;
    double dt0=1.e-4;
     ...
     * T9: photon/e+- temp. Also the WIMP temperature in the case of EM coupled WIMPs
     * Tnu: SM neutrino temp. Simply redshifted in the case of no WIMPs or EM coupled WIMPs.
     * Tnud: SM neutrino decoupling temp. Instantaneous decoupling at 2 MeV assumed. Iteration starts at this temp.
     * Tnu_eq: Temp. of the equivalent neutrinos. Same as Tnu except in the case of WIMPs that couple only to SM neutrinos.
     * Note that we do not need to separately account for the WIMP temp. since this is equal to either T9 or Tnu, depending
     * on their coupling to the SM particles.
     */
